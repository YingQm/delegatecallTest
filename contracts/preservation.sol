...
contract Preservation {
    ...
    // 把 _timeStamp 传入 Attack 合约地址, timeZone1Library 地址变成了 Attack 合约地址, 被篡改
    ...
    // 调用 setFirstTime 可以看到此时 timeZone1Library 已经被修改为我们的攻击 Attack 合约，此时再调用 setSecondTime 函数即可成功更改 owner 变量
